 ...
 */
class ArticleAttachment extends AbstractHelper
{
    /**
     * {@inheritdoc}
     *
    ...
    public function create(array $params = [])
    {
        ...
        $endpoint = sprintf('help_center/articles/%d/attachments.json', $params['id']);
        unset($params['id']);

        return $this->doPostRequest($endpoint, $params);
    }
