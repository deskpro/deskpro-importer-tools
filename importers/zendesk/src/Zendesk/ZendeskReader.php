...
class ZendeskReader
{
    ...
    public function setConfig(array $params)
    {
        ...
        $apiClient  = new HttpClient(@$params['subdomain'], '', 'https', 'zendesk.com', 443, $httpClient);
        $apiClient->setAuth('basic', $params);

        $this->adapter = new RequestClientAdapter($apiClient, $this->logger);
    }
