...
class ZenDeskReader
{
    ...
    public function getPeopleByIds(array $ids)
    {
        ...
        foreach ($chunk_ids as $chunk_ids_batch) {
            $result = $this->adapter->doRequest(new Request(CoreAPI\Person::class, 'find', $chunk_ids_batch));
    ...
    {
        $result = $this->adapter->doRequest(new Request(CoreAPI\Organization::class, 'find', $id));
     ...
     * @return array
     */
    public function getTickets(\DateTime $startTime = null)
    {
     ...
     * @return array
     */
    public function getArticles(\DateTime $startTime = null)
    {
